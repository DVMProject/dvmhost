...
void TSBK::encode(uint8_t* data, bool rawTSBK, bool noTrellis)
{
    ...
    case TSBK_OSP_TIME_DATE_ANN:
    {
        ...
        LogError( LOG_P25 , "TSBK_OSP_TIME_DATE_ANN (DEBUG) Month-$%04X,Day-$%05X,Year-$%013X ,Hour-$%02X,Min-$%02X,Sec-$%02X,TSBK RAW= $%02X" , tmM , tmMDAY, tmY, tmH, tmMin, tmS, tsbkValue );
    }break;
    default:
