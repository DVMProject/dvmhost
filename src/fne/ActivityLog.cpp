...
static std::string g_aclFileRoot;
...
static bool ActivityLogOpen()
{
    ...
    char filename[200U];
    ::sprintf(filename, "%s/%s-%04d-%02d-%02d.activity.log", g_actFilePath.c_str(), g_aclFileRoot.c_str(), tm->tm_year + 1900, tm->tm_mon + 1, tm->tm_mday);
