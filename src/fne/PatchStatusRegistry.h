...
public:
    ...
    /**
     * @brief Maximum number of patches accepted in a single publish for one peer.
     */
    static constexpr size_t MAX_PATCHES_PER_PEER = 64U;
    /**
     * @brief Maximum number of members accepted in a single patch.
     */
    static constexpr size_t MAX_MEMBERS_PER_PATCH = 32U;
    /**
     * @brief Maximum accepted length, in characters, for any string field in a publish request.
     */
    static constexpr size_t MAX_STRING_LENGTH = 128U;
