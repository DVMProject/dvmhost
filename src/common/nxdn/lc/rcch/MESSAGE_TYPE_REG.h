 ...
 */
/**
 * @file MESSAGE_TYPE_REG.h
 * @ingroup nxdn_rcch
 * @file MESSAGE_TYPE_REG.cpp
 * @ingroup nxdn_rcch
 */
...
namespace nxdn
{
    namespace lc
    {
        namespace rcch
        {
            ...
            /**
             * @brief Implements REG - Registration Request (ISP) and
             *  Registration Response (OSP)
             * @ingroup nxdn_rcch
             */
            class DVM_COMMON_API MESSAGE_TYPE_REG : public RCCH {
            public:
                /**
                 * @brief Initializes a new instance of the MESSAGE_TYPE_REG class.
                 */
                MESSAGE_TYPE_REG();
