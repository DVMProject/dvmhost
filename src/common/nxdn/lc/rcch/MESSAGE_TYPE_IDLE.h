 ...
 */
/**
 * @file MESSAGE_TYPE_IDLE.h
 * @ingroup nxdn_rcch
 * @file MESSAGE_TYPE_IDLE.cpp
 * @ingroup nxdn_rcch
 */
...
namespace nxdn
{
    namespace lc
    {
        namespace rcch
        {
            ...
            /**
             * @brief Implements IDLE - Idle
             * @ingroup nxdn_rcch
             */
            class DVM_COMMON_API MESSAGE_TYPE_IDLE : public RCCH {
            public:
                /**
                 * @brief Initializes a new instance of the MESSAGE_TYPE_IDLE class.
                 */
                MESSAGE_TYPE_IDLE();
