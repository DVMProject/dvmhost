 ...
 */
/**
 * @file MESSAGE_TYPE_VCALL_CONN.h
 * @ingroup nxdn_rcch
 * @file MESSAGE_TYPE_VCALL_CONN.cpp
 * @ingroup nxdn_rcch
 */
...
namespace nxdn
{
    namespace lc
    {
        namespace rcch
        {
            ...
            /**
             * @brief Implements VCALL_CONN - Voice Call Connection Request (ISP) and
             *  Voice Call Connection Response (OSP)
             * @ingroup nxdn_rcch
             */
            class DVM_COMMON_API MESSAGE_TYPE_VCALL_CONN : public RCCH {
            public:
                /**
                 * @brief Initializes a new instance of the MESSAGE_TYPE_VCALL_CONN class.
                 */
