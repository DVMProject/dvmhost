 ...
 */
/**
 * @file OSP_MOT_GRG_VCH_UPD.h
 * @ingroup p25_tsbk
 * @file OSP_MOT_GRG_VCH_UPD.cpp
 * @ingroup p25_tsbk
 */
...
namespace p25
{
    namespace lc
    {
        namespace tsbk
        {
             ...
             * @ingroup p25_tsbk
             */
            class DVM_COMMON_API OSP_MOT_GRG_VCH_UPD : public TSBK {
            public:
                /**
                 * @brief Initializes a new instance of the OSP_MOT_GRG_VCH_UPD class.
                 */
                OSP_MOT_GRG_VCH_UPD();
