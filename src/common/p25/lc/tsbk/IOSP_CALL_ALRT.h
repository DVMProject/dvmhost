 ...
 */
/**
 * @file IOSP_CALL_ALRT.h
 * @ingroup p25_tsbk
 * @file IOSP_CALL_ALRT.cpp
 * @ingroup p25_tsbk
 */
...
namespace p25
{
    namespace lc
    {
        namespace tsbk
        {
            ...
            /**
             * @brief Implements CALL ALRT REQ - Call Alert Request (ISP) and
             *  CALL ALRT - Call Alert (OSP)
             * @ingroup p25_tsbk
             */
            class DVM_COMMON_API IOSP_CALL_ALRT : public TSBK {
            public:
                /**
                 * @brief Initializes a new instance of the IOSP_CALL_ALRT class.
                 */
                IOSP_CALL_ALRT();
