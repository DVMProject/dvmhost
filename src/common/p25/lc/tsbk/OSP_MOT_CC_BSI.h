 ...
 */
/**
 * @file OSP_MOT_CC_BSI.h
 * @ingroup p25_tsbk
 * @file OSP_MOT_CC_BSI.cpp
 * @ingroup p25_tsbk
 */
...
namespace p25
{
    namespace lc
    {
        namespace tsbk
        {
            ...
            /**
             * @brief Implements MOT CC BSI - Motorola / Control Channel Base Station Identifier
             * @ingroup p25_tsbk
             */
            class DVM_COMMON_API OSP_MOT_CC_BSI : public TSBK {
            public:
                /**
                 * @brief Initializes a new instance of the OSP_MOT_CC_BSI class.
                 */
                OSP_MOT_CC_BSI();
