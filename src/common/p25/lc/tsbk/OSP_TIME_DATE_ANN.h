 ...
 */
/**
 * @file OSP_TIME_DATE_ANN.h
 * @ingroup p25_tsbk
 * @file OSP_TIME_DATE_ANN.cpp
 * @ingroup p25_tsbk
 */
#if !defined(__P25_LC_TSBK__OSP_TIME_DATE_ANN_H__)
#define  __P25_LC_TSBK__OSP_TIME_DATE_ANN_H__
...
namespace p25
{
    namespace lc
    {
        namespace tsbk
        {
            ...
            /**
             * @brief Implements TIME DATE ANN - Time and Date Announcement
             * @ingroup p25_tsbk
             */
            class DVM_COMMON_API OSP_TIME_DATE_ANN : public TSBK {
            public:
                /**
                 * @brief Initializes a new instance of the OSP_TIME_DATE_ANN class.
                 */
                OSP_TIME_DATE_ANN();
...
#endif // __P25_LC_TSBK__OSP_TIME_DATE_ANN_H__
