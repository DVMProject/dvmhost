 ...
 */
/**
 * @file OSP_SYS_SRV_BCAST.h
 * @ingroup p25_tsbk
 * @file OSP_SYS_SRV_BCAST.cpp
 * @ingroup p25_tsbk
 */
...
namespace p25
{
    namespace lc
    {
        namespace tsbk
        {
             ...
             * @ingroup p25_tsbk
             */
            class DVM_COMMON_API OSP_SYS_SRV_BCAST : public TSBK {
            public:
                /**
                 * @brief Initializes a new instance of the OSP_SYS_SRV_BCAST class.
                 */
                OSP_SYS_SRV_BCAST();
