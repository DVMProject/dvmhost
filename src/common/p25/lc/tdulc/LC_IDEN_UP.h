 ...
 * @ingroup p25_lc
 */
#if !defined(__P25_LC_TDULC__LC_IDEN_UP_H__)
#define  __P25_LC_TDULC__LC_IDEN_UP_H__
...
namespace p25
{
    namespace lc
    {
        namespace tdulc
        {
             ...
             * @ingroup p25_lc
             */
            class DVM_COMMON_API LC_IDEN_UP : public TDULC {
            public:
                /**
...
#endif // __P25_LC_TDULC__LC_IDEN_UP_H__
