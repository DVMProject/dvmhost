 ...
 */
/**
 * @file LC_NET_STS_BCAST.h
 * @ingroup p25_lc
 * @file LC_NET_STS_BCAST.cpp
 * @ingroup p25_lc
 */
#if !defined(__P25_LC_TDULC__LC_NET_STS_BCAST_H__)
#define  __P25_LC_TDULC__LC_NET_STS_BCAST_H__
...
namespace p25
{
    namespace lc
    {
        namespace tdulc
        {
             ...
             * @ingroup p25_lc
             */
            class DVM_COMMON_API LC_NET_STS_BCAST : public TDULC {
            public:
                /**
                 * @brief Initializes a new instance of the LC_NET_STS_BCAST class.
                 */
                LC_NET_STS_BCAST();
...
#endif // __P25_LC_TDULC__LC_NET_STS_BCAST_H__
