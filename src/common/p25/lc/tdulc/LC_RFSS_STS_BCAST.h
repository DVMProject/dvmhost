 ...
 * @ingroup p25_lc
 */
#if !defined(__P25_LC_TDULC__LC_RFSS_STS_BCAST_H__)
#define  __P25_LC_TDULC__LC_RFSS_STS_BCAST_H__
...
namespace p25
{
    namespace lc
    {
        namespace tdulc
        {
             ...
             * @ingroup p25_lc
             */
            class DVM_COMMON_API LC_RFSS_STS_BCAST : public TDULC {
            public:
                /**
...
#endif // __P25_LC_TDULC__LC_RFSS_STS_BCAST_H__
