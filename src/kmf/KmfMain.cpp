...
std::string g_yamlFile = std::string(DEFAULT_CONF_FILE);
...
void usage(const char* message, const char* arg)
{
    ...
    ::fprintf(stdout, "Copyright (c) 2024 Natalie Moore, Bryan Biedenkapp (N2PLL), and DVMProject (https://github.com/dvmproject) Authors.\n");
    if (message != nullptr) {
