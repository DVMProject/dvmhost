...
|$00
|Peer Replication
|This sub-function is used for a CFNE master to transfer the entire certified talkgroup rules configuration to a CFNE peer replica.

|Peer Replication Radio ID Transfer
|$01
|Peer Replication
|This sub-function is used for a CFNE master to transfer the entire certified radio ID lookup configuration to a CFNE peer replica.

|Peer Replication Peer ID Transfer
|$02
|Peer Replication
|This sub-function is used for a CFNE master to transfer the entire certified peer ID lookup configuration to a CFNE peer replica.

|Peer Replication Active Peer List Transfer
|$A2
|Peer Replication
|This sub-function is used for a CFNE peer replica to transfer the internal list of active peers to the CFNE master.
